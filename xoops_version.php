...
//---模組基本資訊---//
$modversion['name']        = 'Wifi認證統計';
$modversion['version']     = 1.00;
$modversion['description'] = '統計freeradius主機認證的資訊';
...
//---模組狀態資訊---//
$modversion['release_date']        = '2017/11/30';
...
$modversion['paypal']['business']      = 'soone.tw@gmail.com';
...
$i                                          = 1;
$modversion['templates'][$i]['file']        = 'soone_freeradius_adm_main.tpl';
$modversion['templates'][$i]['description'] = 'soone_freeradius_adm_main.tpl';

$i++;
$modversion['templates'][$i]['file']        = 'soone_freeradius_index.tpl';
$modversion['templates'][$i]['description'] = 'soone_freeradius_index.tpl';
